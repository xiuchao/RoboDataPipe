...
class MonitorSession:
  ...
  def _load_stream(self, stream_index: int) -> None:
    ...
    requested_cameras = list(self.args.cameras or default_cameras_for_dataset(self.args.dataset, self.args.registry))
    self.args.cameras = resolve_cameras_for_samples(requested_cameras, self.samples)
  ...
  def _build_monitor(self) -> OnlineFailureMonitor:
    return OnlineFailureMonitor(build_monitor_config(self.args))
